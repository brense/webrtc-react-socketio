...
const iceServers = [
  ...
  { urls: 'turn:rfh-auction-coturn.staging.rfh-auction.com:80', username: 'coturn', credential: 'coturn' },
  { urls: 'turn:rfh-auction-coturn.staging.rfh-auction.com:443', username: 'coturn', credential: 'coturn' },
  { urls: 'turn:rfh-auction-coturn.staging.rfh-auction.com:443?transport=tcp', username: 'coturn', credential: 'coturn' },
